...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/creier680x530_atlas_.png", id:"creier680x530_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"creier680x530_atlas_", frames: [[112,284,117,117],[170,148,199,134],[0,0,168,189],[170,0,192,146],[0,191,110,137],[231,295,139,94],[371,0,114,173],[371,175,136,118]]}
];
...
(lib.cerebel = function() {
	this.spriteSheet = ss["creier680x530_atlas_"];
	this.gotoAndStop(0);
...
(lib.creier680x530 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
